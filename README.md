...
- **Bulk operations**
    ...
    - Option to choose “best‑effort” (partial success allowed) or “all‑or‑nothing” (compensating cancellations when
...
- **Compliance**
    ...
    - **GDPR/CCPA**: data minimization, explicit consent, right‑to‑access/delete, and regional data residency where
      required.
...
- Reserve capacity for **technical debt reduction** and **non‑functional improvements** (performance, security,
  observability).
